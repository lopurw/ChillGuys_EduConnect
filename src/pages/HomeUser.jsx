			...
			<div className={classes.statsContainer}>
				...
				{loading ? (
					...
					<div className={classes.stats}>
						<p>Завершенные курсы: <strong>{courseStats.completedCourses}</strong></p>
						<p>Незавершенные курсы: <strong>{courseStats.notCompletedCourses}</strong></p>
					</div>
				)}
			</div>

			<StatisticsChart completed={courseStats.completedCourses}
							 notCompleted={courseStats.notCompletedCourses}/>
		</div>
    );
};
